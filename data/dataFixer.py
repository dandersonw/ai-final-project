...
try:
    ...
    for name in uniqueCardNames:
        ...
        try:
            ...
            print("card error for ", cardResponse[1])
            errorCards.append((cardResponse[0], cardResponse[1], cardResponse[2], cardResponse[3], cardResponse[4], getStatus(statusInt), type))
